  ...
  const groups: NavGroup[] = [
    { heading: 'Operations', items: overview },
    {
      ...
      items: [
        ...
        // Its own screen and its own entitlement since 0204. screenKey stays
        // 'loyalty' because role access is defined by supabase's
        // all_screen_keys() (0096); inventing a key the database does not know
        // would hide this from every role. Whoever may see Loyalty may see the
        // wheel.
        { label: 'Spin & Win', href: '/dashboard/spin', icon: <Ticket size={ICON} />, featureKey: 'spin', screenKey: 'loyalty' },
