...
const GROUPS: { heading: string | null; items: Item[] }[] = [
  {
    heading: null,
    items: [{ key: 'overview', label: 'Overview', href: '/platform-admin', icon: LayoutDashboard }],
  },
  {
    heading: 'Accounts',
    items: [
      { key: 'cafes', label: 'Cafés', href: '/platform-admin/cafes', icon: Store },
      { key: 'users', label: 'Users', href: '/platform-admin/users', icon: Users },
      { key: 'leads', label: 'Leads', href: '/platform-admin/leads', icon: ClipboardList },
    ],
  },
  {
    heading: 'Monitoring',
    items: [
      { key: 'health', label: 'Café health', href: '/platform-admin/health', icon: Activity },
      { key: 'audit', label: 'Audit logs', href: '/platform-admin/audit-logs', icon: ScrollText },
    ],
  },
  {
    heading: 'Console',
    items: [{ key: 'admins', label: 'Admins', href: '/platform-admin/admins', icon: ShieldCheck }],
  },
]
