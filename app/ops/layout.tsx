...
import { AccountMenu } from '@/components/ops/account-menu'
import { MobileNav } from '@/components/ops/mobile-nav'
import { SidebarNav, type NavKey } from '@/components/ops/sidebar-nav'
...
// /ops, and the route is behind an auth gate regardless.
